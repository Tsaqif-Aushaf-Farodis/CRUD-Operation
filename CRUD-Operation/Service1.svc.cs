...
namespace CRUD_Operation
{
    ...
    public class Service1 : IService1
    {
        ...
        {
            string msg;
            SqlConnection con = new SqlConnection("Data Source=TSAQIFJR\\MSSQLSERVER01;Initial Catalog=CRUD_Operations;Persist Security Info=True;User ID=sa;Password=2021Lulus;Pooling=False");
            con.Open();
